...
class FootstepPlanner {
 public:
  ...
  ///  base in horizontal frame (linear and angular stacked) \param[in]
  ///  ftgPositions Target foot positions outputted by the foot trajectory
  ///  generator (in world frame)
  ///
  ////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 private:
  ...
  ///  \param[in] k Numero of the current loop
  ///  \param[in] q Current position vector of the flying base in horizontal
  ///  frame (linear and angular stacked) \param[in] b_v Current velocity vector
  ///  of the flying base in horizontal frame (linear and angular stacked)
  ///  \param[in] b_vref Desired velocity vector of the flying base in
  ///  horizontal frame (linear and angular stacked)
  ///
  ////////////////////////////////////////////////////////////////////////////////////////////////
