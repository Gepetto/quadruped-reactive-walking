...
class StatePlanner3D {
 public:
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////
  ///
  /// \brief Udate the average surface using the heightmap and compute the
  /// configurations
  ///
  /// \param[in] q current position vector of the flying base in horizontal
  /// frame (linear and angular stacked) \param[in] vref desired velocity vector
  /// of the flying base in horizontal frame (linear and angular stacked)
  ///
  ////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  /// frame (linear and angular stacked)
  ///
  ////////////////////////////////////////////////////////////////////////////////////////////////
  void computeReferenceStates(VectorN const& q, Vector6 const& v,
                              Vector6 const& vref);
 ...
 private:
  ...
  MatrixN
      referenceStates_;  // Reference states (12 * (1 + N)) computed for the MPC

  VectorN
      dtVector_;  // Vector containing all time steps in the prediction horizon
  Heightmap heightmap_;  // Environment heightmap
  Vector3 rpyMap_;       // Rotation of the heightmap in RPY
  Vector3 fit_;  // Vector3 such as [a,b,c], such as ax + by -z + c = 0 locally
                 // fits the heightmap
