...
class FootTrajectoryGenerator {
 public:
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////
  ///
  /// \brief Update the next foot position, velocity and acceleration, and the
  /// foot goal position
  ///
  /// \param[in] j Foot id
  /// \param[in] targetFootstep Desired target location at the end of the swing
  /// phase
  ///
  ////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  /// \param[in] targetFootstep Desired target locations at the end of the swing
  /// phases
  ///
  ////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////
  ///
  /// \brief Compute the whole swing trajectory from the current position to the
  /// target on the ground
  ///        Mainly for debug purpose to plot the desired feet trajectory in the
  ///        air
  ///
  /// \param[in] j Foot id
  ///
 ...
 private:
  ...
  double vertTime_;  // Duration during which feet move only along Z when taking
                     // off and landing

  Eigen::Matrix<double, 1, 4>
      feet;         // Column indexes of feet currently in swing phase
