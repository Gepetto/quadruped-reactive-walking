...
class Estimator {
 ...
 private:
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////
  ///
  /// \brief Estimate the position of the base with forward kinematics using a
  /// contact point that
  ///        is supposed immobile in world frame
  ///
  ...
  /// \details The complementary filter combines data from the FK and the IMU
  /// acceleration data
  ///
  /// \param[in] b_perfectVelocity Perfect velocity of the base in the base
  /// frame
  ///
  ////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  /// \details The complementary filter combines data from the FK and the
  /// estimated velocity
  ///
  ...
  Vector3
      alphaPos_;  // Alpha coeefficient for the position complementary filter
  double alphaVelMax_;    // Maximum alpha value for the velocity complementary
                          // filter
  double alphaVelMin_;    // Minimum alpha value for the velocity complementary
                          // filter
  double alphaSecurity_;  // Low pass coefficient for the outputted filtered
  ...
  int phaseRemainingDuration_;  // Number of iterations left for the current
                                // gait phase
  double minElapsed_;           // Minimum non zeros coefficients of
  ...
  Vector6
      vFiltered_;  // Base velocity (in base frame) filtered by averaging window
