...
///
/// \details Handle the communication between the blocks of the control
/// architecture
///
//////////////////////////////////////////////////////////////////////////////////////////////////
...
class Controller {
 public:
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////
  ///
  /// \brief Initialization of some robot parameters (mass, inertia, ...) based
  /// on urdf
  ///
  ////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 private:
  ...
  FootTrajectoryGenerator
      footTrajectoryGenerator;  // Foot Trajectory Generator control block
  ...
  Filter filter_mpc_vref =
      Filter();           // Filter object for base reference velocity
  ...
  Vector12 xgoals;  // Base position, orientation and velocity references for
                    // whole body control
