  ...
  void visit(PyClassJoystick& cl) const {
    cl.def(bp::init<>(bp::arg(""), "Default constructor."))
        ...
        .def("update_v_ref", &Joystick::update_v_ref,
             bp::args("k", "gait_is_static"), "Update joystick values.")
        .def("handle_v_switch", &Joystick::handle_v_switch, bp::args("k"),
             "Handle velocity profile.\n")
        .def("update_for_analysis", &Joystick::update_for_analysis,
             bp::args("des_vel_analysis", "N_analysis", "N_steady"),
             "Set test velocity profile.\n")

        .def("get_p_ref", &Joystick::getPRef, "Get Reference Position")
        .def("get_v_ref", &Joystick::getVRef, "Get Reference Velocity")
        .def("get_joystick_code", &Joystick::getJoystickCode,
             "Get Joystick Code")
        ...
        .def("get_triangle", &Joystick::getTriangle,
        ...
        .def("get_profile_duration", &Joystick::getProfileDuration,
             "Get duration of current velocity profile")
        .def("get_last_reached_velocity", &Joystick::getLastReachedVelocity,
             bp::args("k"), "Get last reached velocity.\n");
  }
